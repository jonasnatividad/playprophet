...
csv_file_path = 'web_app/nba_monte_carlo.csv'  # Replace with the path to your CSV file
...
plt.savefig('social/nba_tweet.png', bbox_inches='tight', pad_inches=0, dpi=104)
...
image_path = 'social/nba_tweet.png'  # Replace with the path to your image file
...
hashtags = "#SportsBetting #PlayProphet #NBABetting #NBAPredictions #NBAGambling #NBAResults #GamblingTwitter #NBA"  
