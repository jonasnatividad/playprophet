...
# Set the sport to 'americanfootball_nfl' for NFL games
...
# Make a request to get odds for NFL over/under markets
...
if odds_response.status_code != 200:
    ...
    df.to_csv('nfl/nfl_odds_api/nfl_odds.csv', index=False)
