...
daily_matchups = 'nba/nba_monte_carlo/nba_data_scraper/daily_matchups.csv'
pf_csv = 'nba/nba_monte_carlo/nba_data_scraper/points_forced.csv'
pa_csv = 'nba/nba_monte_carlo/nba_data_scraper/points_allowed.csv'
...
predictions_csv_file_path = 'web_app/nba_monte_carlo.csv'
log_csv_file_path ='analytics/nba_monte_carlo_log.csv'
