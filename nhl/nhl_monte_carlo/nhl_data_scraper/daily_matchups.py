...
# Set the sport to 'icehockey_nhl' for NHL games
SPORT = 'icehockey_nhl'
...
if odds_response.status_code != 200:
    ...
    # Create a DataFrame
    data = {
        'team_name_1': team2_list,
        'team_name_2': team1_list,
    }

    df = pd.DataFrame(data)

    # Export the DataFrame to a CSV file
    df.to_csv('nhl/nhl_monte_carlo/nhl_data_scraper/daily_matchups.csv', index=False)
