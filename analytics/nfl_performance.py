...
with open('analytics/nfl_analyzer.csv', mode='r') as csv_file:
...
with open('web_app/nfl_performance.csv', mode='w', newline='') as csv_file:
...
print("Win ratios as decimals have been written to nfl_performance.csv.")
