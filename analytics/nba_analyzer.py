...
# Read data from nba_monte_carlo.csv
monte_carlo_data = []
with open('web_app/nba_monte_carlo.csv', 'r') as monte_carlo_file:
...
# Read data from nba_scores.csv
scores_data = []
with open('nba/nba_score_api/nba_scores.csv', 'r') as scores_file:
...
# Read data from nba_odds.csv
odds_data = []
with open('nba/nba_odds_api/nba_odds.csv', 'r') as odds_file:
...
# Append the merged data to the existing file "nba_analyzer.csv" with the updated header
output_file = 'analytics/nba_analyzer.csv'
