...
with open('analytics/nhl_analyzer.csv', mode='r') as csv_file:
...
with open('web_app/nhl_performance.csv', mode='w', newline='') as csv_file:
...
print("Win ratios as decimals have been written to nhl_performance.csv.")
