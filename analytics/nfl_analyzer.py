...
# Read data from nfl_monte_carlo.csv
monte_carlo_data = []
with open('web_app/nfl_monte_carlo.csv', 'r') as monte_carlo_file:
...
# Read data from nfl_scores.csv
scores_data = []
with open('nfl/nfl_score_api/nfl_scores.csv', 'r') as scores_file:
...
# Read data from nfl_odds.csv
odds_data = []
with open('nfl/nfl_odds_api/nfl_odds.csv', 'r') as odds_file:
...
# Append the merged data to the existing file "nfl_analyzer.csv" with the updated header
output_file = 'analytics/nfl_analyzer.csv'
